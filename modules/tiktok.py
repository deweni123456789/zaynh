...
def register_tiktok(app):
    ...
    async def cmd_tiktok(client, message):
        ...
        await message.reply_text("⬇️ Downloading from TikTok...")

        tmpdir = tempdir("tiktok_")
        try:
            ...
            await message.reply_video(str(files[0]), caption=f"From TikTok: {url}")
